    ...
    private var senseDefinition: [String: Any] {[
        ...
        "inputSchema": [
            ...
            "properties": [
                ...
                "momentQuery": [
                    "type": "string",
                    "description": "Optional query for query-specific MomentRanker results. Requires moments=true. This searches the full transcript and returns query-scored rankedMoments."
                ],
                "start": [
                    "type": "string",
